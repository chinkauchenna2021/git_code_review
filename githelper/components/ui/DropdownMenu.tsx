...
// Main DropdownMenu component with compound structure
interface DropdownMenuComponent extends React.FC<React.ComponentProps<typeof DropdownMenuPrimitive.Root>> {
