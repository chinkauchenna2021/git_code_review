...
//                 </Alert>
//               )}
//               <button title='button' onClick={handleGitLogin} className='text-black font-bold'>click</button>
//               <HeroButton
...
function LoginForm() {
  ...
  function handleGitLogin(){
    console.log(isLoading , 'Signing in with GitHub...')
    // clearError()
    // setAuthError(null)
    // signIn('github')
    // signInWithGitHub({callbackUrl})
  ...
  return (
    <div onClick={() => handleGitLogin()}>LoginForm</div>
  )
}
